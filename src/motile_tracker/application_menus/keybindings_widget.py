...
Application Support/motile-tracker/shortcuts.json. Navigation and mouse bindings
...
def open_keybindings_panel(parent: QWidget | None = None) -> KeybindingsWidget:
    ...
    """
    existing = getattr(parent, "_motile_keybindings_panel", None)
    ...
    if parent is not None:
        parent._motile_keybindings_panel = panel
    panel.show()
    panel.raise_()
    return panel
