...
from napari_track_edit.import_export.menus.export_dialog import ExportDialog
from napari_track_edit.import_export.menus.import_dialog import (
    ImportDialog,
)
...
def _as_solution_tracks(tracks: Tracks) -> SolutionTracks:
    ...
    TODO: remove once napari_track_edit operates on Tracks directly and consumers
